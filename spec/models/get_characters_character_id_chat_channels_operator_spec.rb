...
# Unit tests for ESI::GetCharactersCharacterIdChatChannelsOperator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsOperator' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdChatChannelsOperator.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsOperator' do
    it 'should create an instance of GetCharactersCharacterIdChatChannelsOperator' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdChatChannelsOperator)
    end
  end
