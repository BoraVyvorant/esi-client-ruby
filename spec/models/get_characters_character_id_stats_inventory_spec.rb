...
# Unit tests for ESI::GetCharactersCharacterIdStatsInventory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdStatsInventory' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdStatsInventory.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdStatsInventory' do
    it 'should create an instance of GetCharactersCharacterIdStatsInventory' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdStatsInventory)
    end
  end
