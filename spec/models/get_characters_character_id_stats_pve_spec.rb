...
# Unit tests for ESI::GetCharactersCharacterIdStatsPve
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdStatsPve' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdStatsPve.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdStatsPve' do
    it 'should create an instance of GetCharactersCharacterIdStatsPve' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdStatsPve)
    end
  end
