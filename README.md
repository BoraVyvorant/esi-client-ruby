...
```shell
gem install ./esi-client-bvv-1.0.0.gem
```
(for development, run `gem install --dev ./esi-client-bvv-1.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'esi-client-bvv', '~> 1.0.0'
