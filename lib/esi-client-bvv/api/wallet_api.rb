...
module ESI
  class WalletApi
    ...
    def get_characters_character_id_wallet_journal_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v3/characters/{character_id}/wallet/journal/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_corporations_corporation_id_wallets_division_journal_with_http_info(corporation_id, division, opts = {})
      ...
      # resource path
      local_var_path = "/v2/corporations/{corporation_id}/wallets/{division}/journal/".sub('{' + 'corporation_id' + '}', corporation_id.to_s).sub('{' + 'division' + '}', division.to_s)
