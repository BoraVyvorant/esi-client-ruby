...
module ESI
  class AssetsApi
    ...
    def get_characters_character_id_assets_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v3/characters/{character_id}/assets/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_corporations_corporation_id_assets_with_http_info(corporation_id, opts = {})
      ...
      # resource path
      local_var_path = "/v3/corporations/{corporation_id}/assets/".sub('{' + 'corporation_id' + '}', corporation_id.to_s)
    ...
    def post_characters_character_id_assets_locations_with_http_info(character_id, item_ids, opts = {})
      ...
      # resource path
      local_var_path = "/v2/characters/{character_id}/assets/locations/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def post_corporations_corporation_id_assets_locations_with_http_info(corporation_id, item_ids, opts = {})
      ...
      # resource path
      local_var_path = "/v2/corporations/{corporation_id}/assets/locations/".sub('{' + 'corporation_id' + '}', corporation_id.to_s)
